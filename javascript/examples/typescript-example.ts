...
`;
    ...
    try {
        ...
        atomSites.forEach((atom, i) => {
            console.log(`  ${i + 1}. ${atom.element} at (${atom.x.toFixed(3)}, ${atom.y.toFixed(3)}, ${atom.z.toFixed(3)})`);
        });
